...
public partial class ResourceDataBaseData
{
    ...
    /// </summary>
    public ResourceDataBaseData ToIncremental()
    {
    ...
    /// </summary>
    public static ResourceDataBaseData Expand(ResourceDataBaseData incremental)
    {
        if (incremental.DlcFlags == DlcPack.None) return incremental;

        var flags = incremental.DlcFlags;
        var db = new ResourceDataBaseData { DlcFlags = DlcPack.None };
