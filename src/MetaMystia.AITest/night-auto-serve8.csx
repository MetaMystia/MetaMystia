...
public static class AITestAutoServeV8
{
    static readonly int[] FoodRecipes = { 35, 7, 68, 10, 34, 61, 2016, 11000, 2008, 1002, 3004, 3017, 32, 2017, 49, 5002 };
    ...
    {
        if (Co != null) GuestsManager.Instance.StopCoroutine(Co);
        Co = null;
        return Reset();
    }
    ...
    public static string Start()
    {
        ...
        Co = gm.StartCoroutine(Run(gm, Time.realtimeSinceStartup + 480f));
        return Info();
    }
