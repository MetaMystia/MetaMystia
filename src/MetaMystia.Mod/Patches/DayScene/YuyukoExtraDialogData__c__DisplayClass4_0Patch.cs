...
using YuyukoConfirmation = GameData.Core.Collections.DaySceneUtility.Collections.YuyukoExtraDialogData.__c__DisplayClass4_0;
...
public partial class YuyukoExtraDialogData__c__DisplayClass4_0Patch
{
    ...
    [HarmonyPatch(nameof(YuyukoConfirmation._Yuyuko_Challenge_b__2))]
    [HarmonyPrefix]
    public static bool _Yuyuko_Challenge_b__2_Prefix(YuyukoConfirmation __instance, bool confirm)
    {
