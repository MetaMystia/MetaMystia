...
public enum TextId
{
    // 公共连接与房间确认
    MpPublicOnline,
    MpRoomRequestUnavailable,
    MpRoomEntryUnavailable,
    MpRoomIdInvalid,
    MpRoomRequestSubmitted,
    MpRoomLeaving,
    MpRoomCreated,
    MpRoomJoined,
    MpRoomLeft,
    MpRoomKickRequested,
    MpRoomSyncInterrupted,
    MpRoomHostOnly,
    MpRoomFull,
    MpRoomClosed,
    MpRoomMissing,
    MpRoomAlreadyJoined,
    MpRoomBindingChanged,
    MpRoomVersionMismatch,
    MpRoomSettingsInvalid,
    MpServerFull,
    MpConnectionClosed,
    MpConnectionTimeout,
    MpProtocolMismatch,
