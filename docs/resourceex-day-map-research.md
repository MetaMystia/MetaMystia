...
截图：[地图概览](assets/day-map-audit/Overview.png)、[物体后方](assets/day-map-audit/Behind.png)、[物体前方](assets/day-map-audit/Front.png)、[顶层覆盖及初始黑边](assets/day-map-audit/Overhead.png)、[只收缩视口后的半格黑边](assets/day-map-audit/CameraInset.png)、[计入偏移后](assets/day-map-audit/CameraFixed.png)。
